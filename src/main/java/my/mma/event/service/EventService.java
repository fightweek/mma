...
import static my.mma.event.dto.BasicCrawlerDto.EventCrawlerDto.Card;
...
public class EventService {
    ...
    public EventService(FighterRepository fighterRepository, FightEventRepository fightEventRepository) {
            ...
            Mono<Void> saveEventsMono = Mono.fromRunnable(() -> {
                ...
                for (EventCrawlerDto eventDto : eventDtos) {
                    ...
                    if(!prevUpComingEvents.contains(fightEvent)){
                        saveFightEvent(eventDto, fightEvent);
                    }
                }
            });
    ...
    private void saveFightEvent(EventCrawlerDto eventDto, FightEvent fightEvent) {
