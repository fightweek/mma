...
//                ));
        ...
        http.addFilterAt(new LoginFilter(authenticationManager(), jwtUtil, refreshRepository, userRepository, accessExpireMs, refreshExpireMs, objectMapper), UsernamePasswordAuthenticationFilter.class);
